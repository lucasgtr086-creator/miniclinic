...
INSERT OR IGNORE INTO doctor (doctor_id, name, department, specialty, password_hash) VALUES
    ...
    ('D002', '林佩君醫師', '內科',   '心臟血管、高血壓', '$2a$10$XhyEgd4qh5TXJa7NkMg3gOqsJxATykAyJERH7ZqTD7eEPVlcmgewm'),
    ('D003', '王建華醫師', '復健科', '運動傷害、脊椎復健', '$2a$10$XhyEgd4qh5TXJa7NkMg3gOqsJxATykAyJERH7ZqTD7eEPVlcmgewm'),
    ('D004', '李美玲醫師', '小兒科', '兒童感冒、疫苗接種', '$2a$10$XhyEgd4qh5TXJa7NkMg3gOqsJxATykAyJERH7ZqTD7eEPVlcmgewm'),
    ('D005', '張雅筑醫師', '身心科', '焦慮、失眠、情緒調適', '$2a$10$XhyEgd4qh5TXJa7NkMg3gOqsJxATykAyJERH7ZqTD7eEPVlcmgewm');
...
-- 初始掛號資料（appt_id 必須明確指定，INSERT OR IGNORE 才能防止重複）
